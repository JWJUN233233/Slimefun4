    ...
    private static void addHeader(Player p, ChestMenu menu, ItemStack guide) {
        ...
        menu.addItem(
                ...
                new CustomItemStack(
                        ...
                        "",
                        "&fTranslate Chinese fork to English By Ddggdd135",
                        "&fTranslate English to Chinese by StarWishsama",
                        "&cDo not report bugs to Official Slimefun Discord/Github",
                        "&cReport to https://github.com/JWJUN233233/Slimefun4",
                        "",
        ...
        menu.addMenuClickHandler(6, (pl, slot, item, action) -> {
            pl.closeInventory();
            ChatUtils.sendURL(pl, "https://github.com/JWJUN233233/Slimefun4");
            return false;
        });
